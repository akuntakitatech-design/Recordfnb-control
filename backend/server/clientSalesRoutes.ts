      ...
      `INSERT INTO sales_import_rows(
       ...
       SELECT $1::uuid,x.row_no,x.sale_date,x.invoice_number,x.cashier,x.sale_type,x.item_code,x.item_name,x.item_id,
         ...
         FROM JSON_TABLE($2, '$[*]' COLUMNS (
           ...
           item_name VARCHAR(500) PATH '$.item_name', item_id CHAR(36) PATH '$.item_id',
           quantity DECIMAL(20,6) PATH '$.quantity', unit_price DECIMAL(20,4) PATH '$.unit_price', discount_amount DECIMAL(20,4) PATH '$.discount_amount',
